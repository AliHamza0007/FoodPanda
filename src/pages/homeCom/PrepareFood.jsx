import preFood from "../../assets/home/prepare-food.webp";
import homeCorporate from "../../assets/home/homeCorporate.webp";
import barcode from "../../assets/home/pkhomepageqrcode.png";
import appImg from "../../assets/home/home-foodpanda-apps.webp";
    ...
    <div>
      <div className=" my-4 py-5  ">
        <div className="position-relative">
          <WraperCon>
            <p className="fs-2">You prepare the food, we handle the rest</p>
          </WraperCon>
          <img src={preFood} alt="preFood" className="preFood mb-5 " />

          <div className="boxStartedDiv">
            <div className="boxStarted bg-white rounded-4 shadow p-4">
              ...
              <p className="">Interested? Let's start our partnership today!</p>
        ...
        <div className="mt-5 pt-5">
            <Cites />
          <WraperCon>
            <p className="fs-2 mt-5 pt-5">Put us in your pocket</p>

            <div className=" position-relative  bg-pink text-white rounded-4 p-4">
              <div className="col-md-6 col-12 py-2">
                {" "}
                <p className="text-md-start text-center">
                  Download the food and groceries you love
                </p>
                <div className="d-flex flex-md-nowrap  flex-wrap justify-content-md-start  justify-content-center gap-4 py-2">
                  <img
                    src={barcode}
                    alt="barcode"
                    className="img-fluid p-1 barcode rounded-3"
                  />
                  <p>
                ...
                <div className="d-flex flex-wrap text-center justify-content-center  gap-3">
                  <Link
                    to="https://bhpz.adj.st/?adj_t=f6igys&adj_deep_link=foodpanda%3A%2F%2F%3F&adj_campaign=pk_homepage_ios&wssid=1705393737619.38462582599100960.ywxtndluah"
                    target="_blank"
                  ...
                  <Link
                    to="https://bhpz.adj.st/?adj_t=dfv9zs&adj_deep_link=foodpanda%3A%2F%2F%3F&adj_campaign=pk_homepage_android&wssid=1705393737619.38462582599100960.ywxtndluah"
                    target="_blank"
                  ...
                  <Link
                    to="https://bhpz.adj.st/?adj_t=h8w5e0t&adj_deep_link=foodpanda%3A%2F%2F%3F&adj_campaign=pk_homepage_huawei&wssid=1705393737619.38462582599100960.ywxtndluah"
                    target="_blank"
                    className="huawei-store"
                  ...
                  >
                    ...
                    >
                      <g fill="none">
                        <path
                          fill="#B6B6B6"
                          d="M123.928 0H7.416c-.663.01-1.324.068-1.978.176-.65.11-1.28.319-1.867.619-.59.302-1.13.694-1.6 1.162a6.291 6.291 0 0 0-1.163 1.6 6.536 6.536 0 0 0-.616 1.867C.082 6.077.022 6.738.016 7.4c0 .302 0 .606-.016.91v23.332c0 .307 0 .605.016.912.007.662.066 1.323.176 1.976.109.65.317 1.28.616 1.867a6.35 6.35 0 0 0 2.755 2.806c.587.3 1.217.51 1.867.624.654.106 1.316.164 1.978.173H125.9c.66-.008 1.32-.066 1.973-.173a6.728 6.728 0 0 0 1.885-.624 6.155 6.155 0 0 0 1.6-1.163 6.254 6.254 0 0 0 1.168-1.6 6.54 6.54 0 0 0 .61-1.867c.111-.653.173-1.314.185-1.976V7.437a13.284 13.284 0 0 0-.184-1.975 6.608 6.608 0 0 0-.61-1.867A6.4 6.4 0 0 0 129.765.8a6.63 6.63 0 0 0-1.885-.619 13.174 13.174 0 0 0-1.974-.176h-.91L123.929 0z"
                        />
                        <path
                          fill="#000"
                          d="M8.329 39.139h-.894a12.609 12.609 0 0 1-1.845-.16 5.867 5.867 0 0 1-1.635-.534 5.515 5.515 0 0 1-2.4-2.381 5.707 5.707 0 0 1-.534-1.638 12 12 0 0 1-.162-1.85c0-.209-.016-.902-.016-.902V8.337s0-.683.016-.883c.009-.622.067-1.241.173-1.854a5.662 5.662 0 0 1 .533-1.642c.258-.51.597-.976 1.003-1.38a5.544 5.544 0 0 1 1.384-1.01 5.811 5.811 0 0 1 1.632-.533C6.196.935 6.815.88 7.435.872h118.456c.615.005 1.228.059 1.835.16a5.782 5.782 0 0 1 1.648.533 5.502 5.502 0 0 1 2.384 2.4c.259.514.439 1.063.533 1.63a12.8 12.8 0 0 1 .171 1.867V32.57a12.12 12.12 0 0 1-.168 1.83 5.6 5.6 0 0 1-.533 1.648 5.552 5.552 0 0 1-2.384 2.376c-.519.26-1.074.44-1.646.533-.61.1-1.227.153-1.845.16H8.329v.022z"
                        />
                        <path
                          fill="#FFF"
                        ...
                        <path
                          fill="#FFF"
                          d="M53.649 23.556c0-.645-.021-1.356-.064-2.133h1.867c.07.365.118.735.144 1.107a3.534 3.534 0 0 1 2.667-1.27 3.006 3.006 0 0 1 2.813 1.83 5.56 5.56 0 0 1 .456 2.4c.02.898-.162 1.79-.533 2.608-.31.679-.818 1.25-1.456 1.637a4.16 4.16 0 0 1-2.163.558 5.307 5.307 0 0 1-1.752-.299v3.608l-1.995.17.016-10.216z"
                        />
                        <path
                          fill="#000"
                          d="M58.892 28.002c.405-.547.61-1.334.61-2.4 0-.975-.168-1.686-.506-2.134a1.6 1.6 0 0 0-1.333-.656 2.152 2.152 0 0 0-1.067.267 4 4 0 0 0-.936.733v4.667c.22.104.454.181.693.23.258.055.52.084.784.085a2.07 2.07 0 0 0 1.755-.792z"
                        />
                        <path
                          fill="#FFF"
                          d="M62.746 23.556c0-.645-.022-1.356-.064-2.133h1.866c.073.365.122.735.147 1.107.775-.847 1.664-1.27 2.667-1.27a3.006 3.006 0 0 1 2.813 1.83 5.56 5.56 0 0 1 .456 2.4 5.984 5.984 0 0 1-.52 2.608c-.311.68-.82 1.25-1.458 1.637a4.152 4.152 0 0 1-2.163.558 5.307 5.307 0 0 1-1.752-.299v3.608l-1.995.17.003-10.216z"
                        />
                        <path
                          fill="#000"
                          d="M67.997 28.002c.405-.548.608-1.348.608-2.4 0-.975-.168-1.686-.504-2.134a1.6 1.6 0 0 0-1.334-.656 2.163 2.163 0 0 0-1.067.267 4 4 0 0 0-.936.733v4.667c.222.104.454.18.694.23.257.055.52.084.784.085.68.04 1.335-.256 1.755-.792z"
                        />
                        <path
                          fill="#FFF"
                          d="M74.298 29.583a4.851 4.851 0 0 1-1.987-2.045 6.715 6.715 0 0 1-.693-3.15 6.587 6.587 0 0 1 .8-3.347 5.155 5.155 0 0 1 2.176-2.066 6.811 6.811 0 0 1 3.089-.691 8.086 8.086 0 0 1 1.925.224 8.18 8.18 0 0 1 1.707.608l-.507 1.533a7.083 7.083 0 0 0-3.037-.757 4.25 4.25 0 0 0-2.134.533 3.547 3.547 0 0 0-1.427 1.531 5.371 5.371 0 0 0-.506 2.438c-.014.757.118 1.51.389 2.218a3.288 3.288 0 0 0 1.237 1.537c.638.399 1.382.596 2.134.565.39-.001.778-.034 1.163-.099a5.88 5.88 0 0 0 1.09-.282v-2.366h-2.715v-1.55h4.643v4.918c-.673.314-1.379.555-2.104.718a9.822 9.822 0 0 1-2.192.25 6.195 6.195 0 0 1-3.05-.72zm14.433.552a7.657 7.657 0 0 1-.138-1.154c-.334.387-.74.705-1.198.933a3.563 3.563 0 0 1-1.667.384 3.139 3.139 0 0 1-1.37-.296 2.248 2.248 0 0 1-.98-.888 2.715 2.715 0 0 1-.364-1.448 2.48 2.48 0 0 1 .914-2.022c.608-.503 1.623-.754 3.043-.754.53 0 1.058.037 1.582.112v-.171c0-.768-.164-1.31-.491-1.627a1.968 1.968 0 0 0-1.414-.472c-.46.006-.92.068-1.365.187a7.16 7.16 0 0 0-1.285.443l-.315-1.451a7.68 7.68 0 0 1 1.403-.446 8.233 8.233 0 0 1 1.842-.202 4.8 4.8 0 0 1 1.92.344c.537.237.974.654 1.235 1.179.328.702.48 1.473.446 2.248V28.5c0 .355.021.901.064 1.637l-1.862-.003z"
                        />
                        <path
                          fill="#000"
                          d="M87.537 28.535c.384-.178.73-.431 1.016-.744v-1.6a12.913 12.913 0 0 0-1.334-.088c-.825 0-1.395.133-1.71.4a1.333 1.333 0 0 0-.471 1.067c-.03.353.096.701.344.955.26.219.594.33.933.312.425-.007.843-.11 1.222-.302z"
                        />
                        <path
                          fill="#FFF"
                          d="M92.07 28.045V17.75l1.984-.16v10.1c-.025.276.042.552.19.787a.736.736 0 0 0 .602.232c.181-.008.36-.039.534-.091l.234 1.43a3.432 3.432 0 0 1-.69.18 4.723 4.723 0 0 1-.771.07c-1.389 0-2.083-.751-2.083-2.253zm4.963 0V17.75l1.987-.16v10.1c-.025.276.041.552.19.787a.736.736 0 0 0 .602.232c.18-.008.36-.039.533-.091l.232 1.43a3.403 3.403 0 0 1-.688.18 4.728 4.728 0 0 1-.773.07c-1.387 0-2.081-.751-2.083-2.253zm11.705-2.011h-5.7c.092 1.826.96 2.739 2.609 2.739a5.6 5.6 0 0 0 1.256-.15c.42-.098.832-.231 1.23-.4l.437 1.366a7.443 7.443 0 0 1-3.286.709 4.8 4.8 0 0 1-2.341-.533 3.358 3.358 0 0 1-1.435-1.51 5.374 5.374 0 0 1-.48-2.373 5.614 5.614 0 0 1 .51-2.486 3.704 3.704 0 0 1 1.416-1.6 3.976 3.976 0 0 1 2.096-.55 3.52 3.52 0 0 1 2.061.58c.55.382.977.916 1.227 1.538.275.677.41 1.403.4 2.134v.536z"
                        />
                        <path
                          fill="#000"
                          d="M106.794 24.767a2.507 2.507 0 0 0-.534-1.563 1.6 1.6 0 0 0-1.25-.52 1.683 1.683 0 0 0-1.264.534 2.779 2.779 0 0 0-.66 1.557l3.708-.008z"
                        />
                        <path
                          fill="#FFF"
                          d="M110.247 23.612c0-.477-.024-1.208-.066-2.187h1.866c.032.243.062.534.094.867.032.334.048.61.058.822.201-.34.43-.663.683-.966.22-.258.486-.475.784-.637a2.07 2.07 0 0 1 1.022-.248c.27-.007.54.026.8.098l-.251 1.729a2.293 2.293 0 0 0-1.867.266c-.436.33-.815.73-1.123 1.182v5.6h-1.984l-.016-6.526zm6.35 10.088a4.814 4.814 0 0 1-.717-.172l.362-1.454c.168.045.338.082.51.11.192.034.386.051.581.053.89 0 1.55-.568 1.984-1.704l.131-.323-3.2-8.785h2.133l1.616 4.91c.21.632.378 1.276.507 1.928.152-.63.328-1.259.533-1.888l1.64-4.95h2.009l-3.2 8.825a9.08 9.08 0 0 1-.98 2.019 3.416 3.416 0 0 1-1.237 1.136 3.696 3.696 0 0 1-1.725.373 5.448 5.448 0 0 1-.947-.077zM41.595 7.302h3.547l-.099.859h-2.4v1.661h2.275v.8h-2.275v1.84h2.541l-.088.867h-3.501zm5.998 2.955-1.867-2.955h1.184l1.27 2.17 1.333-2.17h1.149l-1.867 2.917 2.02 3.115h-1.201l-1.437-2.373-1.465 2.373h-1.149zm3.987-2.955h1.626c.763 0 1.348.155 1.755.467a1.6 1.6 0 0 1 .608 1.349c.011.367-.081.73-.267 1.048a1.795 1.795 0 0 1-.76.688c-.35.165-.733.248-1.12.24a4.534 4.534 0 0 1-.8-.083v2.323H51.58V7.302z"
                        />
                        <path
                          fill="#000"
                          d="M54.193 9.995a1.09 1.09 0 0 0 .333-.85.923.923 0 0 0-.338-.8c-.3-.183-.65-.269-1-.246h-.566v2.134c.198.035.399.056.6.061.35.026.697-.08.97-.299z"
                        />
                        <path
                          fill="#FFF"
                          d="M56.598 7.302h1.04v5.141h2.497l-.088.891h-3.449zm5.121 5.736a2.501 2.501 0 0 1-1.014-1.067 3.467 3.467 0 0 1-.349-1.6 3.568 3.568 0 0 1 .373-1.67 2.603 2.603 0 0 1 1.067-1.103 3.336 3.336 0 0 1 1.667-.379 3.12 3.12 0 0 1 1.57.376c.435.247.785.619 1.006 1.067.238.493.356 1.034.344 1.581a3.582 3.582 0 0 1-.376 1.688c-.239.466-.61.85-1.067 1.105a3.33 3.33 0 0 1-1.64.389 3.107 3.107 0 0 1-1.581-.387z"
                        />
                        <path
                          fill="#000"
                          d="M64.418 12.3c.294-.195.522-.474.656-.8.15-.374.223-.774.216-1.177a3.267 3.267 0 0 0-.192-1.16c-.12-.322-.334-.6-.614-.8a2.067 2.067 0 0 0-2.157 0c-.295.205-.525.49-.662.822a2.8 2.8 0 0 0-.22 1.133c-.007.4.063.8.207 1.173.262.703.95 1.154 1.699 1.115.378.01.75-.098 1.067-.307z"
                        />
                        <path
                          fill="#FFF"
                          d="M67.543 7.302h1.888a2.507 2.507 0 0 1 1.566.413 1.4 1.4 0 0 1 .533 1.179c.006.292-.06.582-.192.843a1.867 1.867 0 0 1-.475.594 2.133 2.133 0 0 1-.586.336l1.866 2.667H70.93l-1.57-2.4h-.766v2.4h-1.05V7.302z"
                        />
                        <path
                          fill="#000"
                          d="M69.178 10.155c.232.005.461-.045.67-.146.187-.09.345-.232.455-.408.11-.189.167-.404.163-.622a.763.763 0 0 0-.288-.664 1.403 1.403 0 0 0-.837-.21h-.755v2.061l.592-.01z"
                        />
                        <path
                          fill="#FFF"
                          d="M72.957 7.302h3.555l-.102.859h-2.4v1.661h2.254v.8h-2.275v1.84h2.541l-.088.867h-3.485zm7.422 0h1.04v6.032h-1.04zm3.795.869h-1.867l.09-.87h4.694l-.096.87h-1.779v5.163h-1.042zm7.437 4.867a2.496 2.496 0 0 1-1.01-1.067 3.432 3.432 0 0 1-.352-1.6 3.568 3.568 0 0 1 .373-1.67 2.616 2.616 0 0 1 1.067-1.103 3.35 3.35 0 0 1 1.656-.39 3.107 3.107 0 0 1 1.57.377c.436.246.786.617 1.006 1.066.239.493.358 1.035.347 1.582a3.552 3.552 0 0 1-.379 1.688c-.238.466-.61.85-1.067 1.104a3.315 3.315 0 0 1-1.64.39 3.107 3.107 0 0 1-1.57-.377z"
                        />
                        <path
                          fill="#000"
                          d="M94.313 12.3c.293-.196.52-.475.653-.8.15-.374.223-.774.216-1.177a3.267 3.267 0 0 0-.192-1.16 1.71 1.71 0 0 0-.61-.8 2.07 2.07 0 0 0-2.16 0c-.295.205-.525.49-.662.822-.15.358-.226.744-.221 1.133-.007.4.064.8.208 1.173.127.33.349.613.637.816.316.209.689.313 1.067.3.377.007.748-.1 1.064-.308z"
                        />
                        <path
                          fill="#FFF"
                          d="M97.438 7.302h1.195l2.984 4.675a20.507 20.507 0 0 1-.037-1.23V7.302h.966v6.032h-1.158l-3.03-4.75c.03.534.046 1.017.046 1.435v3.315h-.966V7.302z"
                        />
                        <path
                          fill="#C8102E"
                        ...
                        <path
                          fill="#FFF"
                          d="M13.745 20.001h.672v3.313h-.672v-1.347h-1.518v1.347h-.672V20h.672v1.334h1.518zm3.787 1.896c0 .534-.267.827-.752.827-.486 0-.758-.296-.758-.85v-1.867h-.672V21.9c0 .93.518 1.464 1.42 1.464.9 0 1.434-.533 1.434-1.493v-1.867h-.672v1.893zm7.766.382L24.546 20h-.552l-.752 2.278L22.514 20h-.715l1.155 3.313h.557l.752-2.177.752 2.177h.563L26.73 20h-.699zm2.635-.392h1.224v-.603h-1.224v-.677h1.776V20H27.27v3.307h2.502v-.602h-1.84zm2.64 1.421h.664v-3.307h-.664zm-11.041-.685-.301.688h-.686L19.993 20h.592l1.454 3.31h-.704l-.275-.685z"
                        />
                        <path
                          fill="#C8102E"
                        ...
                        <path
                          fill="#FFF"
                          d="M21.396 15.785a4.219 4.219 0 0 1-4.216-4.216h.595a3.622 3.622 0 0 0 7.243 0h.594a4.219 4.219 0 0 1-4.216 4.216z"
                        />
                      </g>
                    </svg>
                  </Link>
              ...
              <div className="col-md-6 col-12 text-center ">
                <img src={appImg} alt="appImg" className="img-fluid appImg" />
              </div>
            </div>
          </WraperCon>
        </div>
      </div>
      <div className=" position-relative orderSummery">
        <WraperCon>
          <p className="fs-2">Take your office out to lunch</p>
        </WraperCon>
        <img src={homeCorporate} alt="homeCorporate" className="preFood mb-5" />

        <div className="boxStartedDiv2">
          <div className="boxStarted bg-white rounded-4 shadow p-4">
            <p className="fs-4 fw-semibold ">foodpanda for business </p>
            <p className="">
        ...
        <div className="container my-5 py-5">
          <WraperCon>
            <div className="col-12">
              <h2 className="font-bold lh-1 ">
                Order food and groceries online from the best{" "}
                <br className="d-lg-block d-none" /> restaurants and shops on
                foodpanda{" "}
              </h2>
              <p>
                ...
                make your every day easier.
              </p>
              <h2 className="font-bold" style={{ margin: "26px 0" }}>
                What's new?
              </h2>
              <ul className="list-unstyled">
                <li>
                  <span className="color-pink">✓</span> Wide variety of
                  restaurants and shops, an abundance of cuisines &amp;
                  products.
                </li>
                <li>
                  <span className="color-pink">✓</span> High quality delivery
                  service.
                </li>
                <li>
                  <span className="color-pink">✓</span> Live chat feature to
                  give App users instant help when they need it.
                </li>
                <li>
                  <span className="color-pink">✓</span> NEW: foodpanda grocery
                  delivery! Discover the best shops, pharmacies, bakeries and
                  more near you.{" "}
                </li>
                <hr />
                ...
                <div>
                  ...
                  <div>
                    <div>
                      <p>
                        {" "}
                        To get foodpanda delivery, simply locate the restaurants
                        and shops near you by typing in your address, browse
                        through a variety of restaurants and cuisines, check
                        menus and prices, choose your dishes and add them to the
                        basket. Now you only need to checkout and make the
                        payment. Soon your delicious food will arrive at your
                        doorstep!
                      </p>
                    </div>
                  </div>
                ...
                <div>
                  ...
                  <div>
                    <div>
                      <p>
                        {" "}
                        You can check which takeout restaurants are open now
                        near you by simply typing your address in the location
                        bar on foodpanda and pressing search. You will see all
                        the available restaurants and shops that deliver to your
                        area.{" "}
                      </p>
                    </div>
                  </div>
                ...
                <div>
                  ...
                  <div>
                    <div>
                      <p>
                        Yes, foodpanda in Pakistan delivers 24 hours. However,
                        many restaurants may be unavailable for a late-night
                        delivery. Please check which places in Pakistan deliver
                        to you within 24 hours by using your address. You can
                ...
                <div>
                  ...
                  <div>
                    <div>
                      <p>
                        Yes, you can pay cash on delivery for foodpanda in
                        Pakistan.
                      </p>
                    </div>
                  </div>
                ...
                <div>
                  ...
                  <div>
                    <div>
                      <p>
                        You can pay online while ordering at foodpanda Pakistan
                        by using a credit or debit card or PayPal.
                      </p>
                    </div>
                  </div>
                </div>
                <div>
                  ...
                  <div>
                    <div>
                      Yes, foodpanda Pakistan allows you to place an order for
                      someone else. During checkout, just update the name and
                      delivery address of the person you're ordering for. Please
                      keep in mind that if the delivery details are not correct
                      and the order cannot be delivered, we won't be able to
                      process a refund.
                    </div>
                  </div>
                </div>
                <div>
                  ...
                  <div>
                    <div>
                      <p>
                        {" "}
                        Delivery fee charged by foodpanda in Pakistan depends on
                        many operational factors, most of all - location and the
                        restaurant you are ordering from. You can always check
                        the delivery fee while forming your order. Besides, you
                        can filter the restaurants by clicking on the "Free
                        Delivery" icon at the top of your restaurant listing.
                      </p>
                    </div>
                  </div>
                </div>
                <div>
                  ...
                  <div>
                    <div>
                      <p>
                        There are hundreds of restaurants on foodpanda Pakistan
                        that let you order online. For example,{" "}
                        <Link
                          className="text-decoration-none color-pink"
                          to="https://www.foodpanda.pk/chain/cs5rw/kfc"
                        >
                          KFC
                        </Link>
                        ,{" "}
                        <Link
                          className="text-decoration-none color-pink"
                          to="https://www.foodpanda.pk/chain/cz8ck/mcdonalds"
                        >
                          McDonald's
                        </Link>
                        ,{" "}
                        <Link
                          className="text-decoration-none color-pink"
                          to="https://www.foodpanda.pk/chain/ct1yx/pizza-hut"
                        >
                          Pizza Hut
                        </Link>
                        ,{" "}
                        <Link
                          className="text-decoration-none color-pink"
                          to="https://www.foodpanda.pk/chain/ca5vf/one-potato-two-potato"
                        >
                          OPTP
                        </Link>
                        ,{" "}
                        <Link
                          className="text-decoration-none color-pink"
                          to="https://www.foodpanda.pk/chain/ct7xe/hardees"
                        >
                          Hardee's
                        </Link>
                        ,{" "}
                        <Link
                          className="text-decoration-none color-pink"
                          to="https://www.foodpanda.pk/chain/cs1zc/domino-s"
                        >
                          Domino's
                        </Link>
                        ,{" "}
                        <Link
                          className="text-decoration-none color-pink"
                          to="https://www.foodpanda.pk/chain/cr5xo/kababjees-machs"
                        >
                          Kababjees
                        </Link>{" "}
                        and many-many more! In order to check all the
                        restaurants near you that deliver, just type in your
                ...
                <div>
                  ...
                  <div>
                    <div>
                      <p>
                        Yes, many restaurants have a minimum order. The minimum
                        order value depends on the restaurant you order from and
                ...
                <div>
                  ...
                  <div>
                    <div>
                      <p>
                        If you choose delivery, a foodpanda rider will collect
                        your order from the restaurant and take it to your
                        chosen delivery address. If you choose Pick-Up, you can
                        takeaway your food directly from the restaurant for
                        extra savings – and to jump to the front of the queue.
                ...
                <p>
                  Order food and groceries online with foodpanda now and enjoy a
